    ...
    <div class="container">
        <div class="dashboard">
            ...
            <div class="dash-right">
                ...
                <!-- skill section -->
                <div class="link-content" id="Skill">
                    <div class="dash-hero">
                        <i class="fas fa-tools"></i><span>Skill</span>
                    </div>
                    <div class="prof-form">
                        <h3>skills Form</h3>
                        <p>Please fill the form and Submit</p>
                        <form class="Prof-forn-input" method="post" action="logic.php">
                            <label>Enter the skills you posses <textarea name="skill" id="" required></textarea></label>
                            <div class="btn">
                                <button class="prof-btn" type="submit" name="add_skill">add to cv</button>
                                <a href="language.php"  class=" next"><span>Next</span></a>
