    ...
    <div class="container">
        <div class="dashboard">
            ...
            <div class="dash-right">
                ...
                <div class="link-content" id="Hobby">
                    <div class="dash-hero">
                        <i class="fas fa-palette"></i><span>Hobby</span>
                    </div>
                    <div class="prof-form">
                        <h3>Hobby Form</h3>
                        <p>Please fill the form and Submit</p>
                        <form class="Prof-forn-input" method="post" action="logic.php">
                            <label>Enter your hobbby <input type="text" name="hobby" required></label>
                            <div class="btn">
                                <button class="prof-btn" type="submit" name="add_hobby">add to cv</button>
                                <a href="volunteering.php" class=" next"><span>Next</span></a>
