    ...
    <div class="container">
        <div class="dashboard">
            ...
            <div class="dash-right">
                ...
                <div class="link-content" id="Education">
                    <div class="dash-hero">
                    ...
                    <div class="prof-form">
                        ...
                        <form class="Prof-forn-input" method="post" action="logic.php">
                            <label>what is the name of the certificate<input type="text" name="edu_title" required></label>
                            <label>which institition did you obtain your cerificate <input type="text" name="institution"  required></label>
                            <label>when did you obtain certificate <input type="date" name="time" required></label>
                            <div class="btn">
                                <button class="prof-btn" type="submit" name="add_education">add to cv</button>
                                <a href="experience.php"  class=" next"><span >Next</span></a>
